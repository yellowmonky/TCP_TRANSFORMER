...
sys.path.insert(0, "/home/a/TCP/scenario_runner")
from srunner.scenariomanager.carla_data_provider import *
from srunner.scenariomanager.timer import GameTime
from srunner.scenariomanager.watchdog import Watchdog

sys.path.insert(0, "/home/a/TCP/leaderboard")
...
class LeaderboardEvaluator(object):
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            # for waypoint 여기에서 에고 차량 객체를 에이전트에 할당해줍니다.
            if scenario.ego_vehicles and len(scenario.ego_vehicles) > 0:
                ego_vehicle = scenario.ego_vehicles[0]  # 첫 번째 차량을 에고 차량으로 사용
                self.agent_instance.set_vehicle(ego_vehicle)  # 에고 차량 객체를 TCPAgent에 할당
                print("에고 차량 할당 완료:", ego_vehicle)
            else:
                raise RuntimeError("에고 차량을 찾을 수 없습니다.")
            #for waypoint
    ...
    def run(self, args):
        ...
        """
        agent_class_name = getattr(self.module_agent, 'get_entry_point')() #for waypoint
        self.agent_instance = getattr(self.module_agent, agent_class_name)(args.agent_config)#for waypoint
